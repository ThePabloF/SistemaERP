...
//
//        // Crear el proveedor
//        Proveedor proveedor = new Proveedor(idProveedores++, nombre, telefono, correo);
...
//        }
//        System.out.println("¿Producto con IVA? (Si/No)");
//        String productoIva = scanner.next();
//        if (productoIva.equalsIgnoreCase("si")) {
//            ProductoIva producto = new ProductoIva(idproductos++,nombreProducto,precioUnitario,categoriaSeleccionada,proveedorSeleccionado);
//        }
//
//    }
//
